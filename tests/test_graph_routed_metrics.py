...
def _tr(
    from_state: str, to_state: str, condition: str = "always",
    agent: str | None = None, passes: int = 10, context: int = 0,
    cycles: int = 0,
) -> TransitionRecord:
...
class TestPerPromptMetrics:
    ...
    def test_transition_count(self):
        transitions = [
            _tr("A", "B"), _tr("B", "C"), _tr("C", "D"), _tr("D", "E"),
        ]
        m = compute_per_prompt_metrics(transitions)
    ...
    def test_state_histogram(self):
        transitions = [
            _tr("A", "B"), _tr("B", "C"), _tr("C", "B"), _tr("B", "D"),
        ]
        m = compute_per_prompt_metrics(transitions)
    ...
    def test_error_type_distribution(self):
        transitions = [
            _tr("CODE_EXECUTED", "ERROR_CLASSIFICATION",
                 condition="execution_success == false"),
            _tr("ERROR_CLASSIFICATION", "CODE_WRITTEN",
                 condition="error_type in ['SyntaxError']"),
        ]
        m = compute_per_prompt_metrics(transitions)
...
class TestCrossPromptMetrics:
    ...
    def test_multiple_prompts(self):
        metrics = [
            {
                "total_transitions": 4, "path_efficiency": 1.0,
                "resource_utilization": 0.3, "escalations_triggered": 0,
                "cycle_count": 0, "initial_complexity": "simple",
            },
            {
                "total_transitions": 10, "path_efficiency": 0.7,
                "resource_utilization": 0.8, "escalations_triggered": 1,
                "cycle_count": 2, "initial_complexity": "moderate",
            },
            {
                "total_transitions": 15, "path_efficiency": 0.5,
                "resource_utilization": 0.9, "escalations_triggered": 2,
                "cycle_count": 5, "initial_complexity": "complex",
            },
        ]
    ...
    def test_omission_high_cycles(self):
        metrics = [
            {"cycle_count": 5, "path_efficiency": 0.2,
             "total_transitions": 10, "resource_utilization": 0.8,
             "escalations_triggered": 0},
        ]
        m = compute_cross_prompt_metrics(metrics)
    ...
    def test_commission_low_efficiency(self):
        metrics = [
            {"path_efficiency": 0.3, "cycle_count": 0,
             "total_transitions": 10, "resource_utilization": 0.5,
             "escalations_triggered": 0},
        ]
        m = compute_cross_prompt_metrics(metrics)
    ...
    def test_mean_path_per_complexity(self):
        metrics = [
            {"initial_complexity": "simple", "total_transitions": 4,
             "path_efficiency": 1.0, "resource_utilization": 0.3,
             "escalations_triggered": 0, "cycle_count": 0},
            {"initial_complexity": "simple", "total_transitions": 6,
             "path_efficiency": 0.9, "resource_utilization": 0.4,
             "escalations_triggered": 0, "cycle_count": 0},
            {"initial_complexity": "complex", "total_transitions": 15,
             "path_efficiency": 0.7, "resource_utilization": 0.8,
             "escalations_triggered": 1, "cycle_count": 2},
        ]
        m = compute_cross_prompt_metrics(metrics)
